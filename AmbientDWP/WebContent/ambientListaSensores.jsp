...
<div class="container">
  <div class="header"><a href="#"></a>
    <table width="961" border="1">
      <tr bgcolor="#66CC99">
        <th width="107"><div align="center"><a href="#" onclick="enviar('inicio')">INICIO</a></div></th>
        <th width="294"><div align="center"><a href="#" onclick="enviar('inicio')">GEOLOCALIZACION</a></div></th>
        <th width="153"><div align="center"><a href="#" onclick="enviar('inicio')">ESTADISTICAS</a></div></th>
        <th width="260"><div align="center"><a href="#" onclick="enviar('inicio')">ADMINISTRACION</a></div></th>
        <th width="113"><div align="center"><a href="#" onclick="enviar('inicio')">CONTACTO</a></div></th>
      </tr>
    </table> 
		  ...
		  %>
          		<tr>
            		<td width="230"><div align="center">
            			<a href=<%=enlace%>><span class="textosimple"><%=nuevoId%></span></a>
            		</div></td>
          		</tr>
          <% 	} 
            } else {
